...
- **Server-side Maps E2E configuration:** `web-e2e-ci.yml` accepts the optional `google_maps_platform_server_api_key` secret and enables `GoogleMapsPlatform` only for the API process when the credential is present.
